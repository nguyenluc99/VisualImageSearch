...
def make_ds_for_general(dataset_path: str, save_path: str) -> None:
    ...
    print('The number of classes: {}'.format(len(img_dirs)))
    with open('data_jsons/json.json', 'w') as f:
        json.dump({'nr_class': len(img_dirs), 'path_type': 'absolute_path', 'info_dicts': info_dicts}, f)
